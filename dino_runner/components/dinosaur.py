...
from dino_runner.utils.constants import DEAD, DEFAULT_TYPE, SHIELD_TYPE, HAMMER_TYPE, RUNNING, DUCKING, JUMPING, RUNNING_SHIELD, JUMPING_SHIELD, DUCKING_SHIELD, RUNNING_HAMMER,  JUMPING_HAMMER, DUCKING_HAMMER
